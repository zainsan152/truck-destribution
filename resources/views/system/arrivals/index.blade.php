            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">Ajouter les Arrivage</h3>
                    </div>
                    <div class="card-body">
                        <div class="col-md-6">
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header" style="display: flex; align-items: center;">
                        ...
                        <button class="btn btn-primary" id="arrivalFromBtn" style="margin-left: auto;">Ajouter un
                            arrivage
                        </button>
                    </div>
                    <div class="card-body">
    ...
    <script>
        var table = $('#arrivals-table').DataTable({
            ...
            buttons: [
                {
                    extend: 'excelHtml5',
                    title: 'Exported Arrivals' + ' ' + new Date(),
